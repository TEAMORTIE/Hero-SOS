  ...
  <body>
    <div class="navbar">
      ...
      <ul class="links">
        ...
        <li><a href="pages/incident.php">Déclarer un incident</a></li>
        <li><a href="pages/comment_ca_marche.php">Comment ca marche ?</a></li>
      </ul>
      <div class="buttons">
        <?php
...
?>
<a href="pages/inscription.php" class="action-button pro">S'enregistrer</a>

          <a href="pages/connexion.php" class="action-button co">Se connecter</a>
...
<a href="pages/profil.php" class="action-button pro">Profil</a>
          ...
          <?php
            ...
            ?>
          <a href="pages/dashboard.php" class="action-button pro">DASHBOARD</a>
          <?php
          }
else {
          ?>
