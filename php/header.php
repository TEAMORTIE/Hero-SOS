...
<ul class="links">
     <li class="dropdown ml-3">
            ...
            <ul
              class="dropdown-menu shadow-md bg-white text-black shadow-black/5 z-30 hidden py-1.5 rounded-md border border-gray-100 max-w-[140px]"
            >
              <li>
                <a 
                  href="profil.php"
...
?>
    ...
    <div class="burger-menu">
      <ul class="links">
        <li><a href="../index.php">Accueil</a></li>
        <li><a href="hero.php">Les Supers-heros</a></li>
        <li><a href="vilan.php">Les Supers-vilans</a></li>
        <li><a href="incident.php">Déclarer un incident</a></li>
        <li><a href="comment_ca_marche.php">Comment ca marche ?</a></li>
